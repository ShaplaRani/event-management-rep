            ...
            <footer className="  grid grid-cols-2 md:grid-cols-4 justify-between text-black w-10/12 
             mx-auto ">
                <nav className="text-base font-medium text-gray-700" data-aos="fade-up"
                    ...
                    <p className="link link-hover">Weddings</p>
                    <p className="link link-hover">Birthday Parties</p>
                    <p className="link link-hover">Anniversaries Parties</p>
                    <p className="link link-hover">Engagement Parties</p>
                    <p className="link link-hover">Retirement Parties</p>
                    <p className="link link-hover">Baby shower</p>
                </nav>
                <nav className="text-base font-medium text-gray-700" data-aos="fade-up"
                    data-aos-easing="ease-out-cubic"
                    data-aos-duration="1000">
